...
const DIRECTAS = ['leads', 'conversations', 'conv_daily', 'appointments', 'agent_presence',
  ...
  'tenant_users', 'tenant_modulos', 'tenants', 'settings', 'tenant_templates', 'tenant_solicitudes', 'tenant_services', 'calendar_exceptions', 'booking_claims', 'tenant_media', 'tenant_media_uploads'];
