...
export const TERRS: Record<string, string> = {
  ...
  plan_channel_kind: 'Las redes sociales van en el plan Profesional. Cámbiale el plan en «Plan y módulos» y vuelve a intentarlo.',
  invalid_channel_kind: 'Ese canal no se puede conectar desde aquí.',
  invalid_channel_address: 'El ID de la página de Facebook son solo dígitos (5 a 25), no el nombre ni la URL.',
  modulo_no_contratado: 'Este módulo no está habilitado para tu cuenta.',
  invalid_plan: 'Selecciona un plan válido.',
  invalid_modulos: 'Revisa los módulos seleccionados.',
  citas_requires_calendario: 'Citas necesita el módulo Calendario.',
  ...
  permiso_invalido: 'Ese permiso no existe.',
  permiso_duplicado: 'Ese admin ya tiene ese permiso.',
  permiso_de_raiz: 'Es una cuenta raíz: ya tiene todos los permisos y no se le pueden quitar desde el panel.',
  permiso_del_entorno: 'Ese permiso le viene de la configuración del worker (SOCIOS_EMAILS): se cambia en wrangler.toml, no aquí.',
  email_no_es_admin: 'Ese correo no es admin de Velai: dale primero acceso de admin y luego el permiso.',
