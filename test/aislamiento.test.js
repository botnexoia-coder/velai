...
const CASOS = [
  ...
  { key: '/api/admin/events', m: 'GET', path: () => '/api/admin/events' },
  { key: 'events\\/reservations\\/', m: 'PATCH', path: () => '/api/admin/events/reservations/00000000-0000-4000-8000-0000000000a3', body: { status: 'confirmed' } },
