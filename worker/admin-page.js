...
<div class="mt6"><b>Horario laboral</b><p class="muted">Las horas en las que Vai puede ofrecer cita. Deja en blanco los días que no atendéis; el segundo tramo es para las jornadas partidas. Si lo dejas todo en blanco se usa el horario por defecto: <b>lunes a viernes de 9:00 a 19:00</b>.</p>
<div class="shgrid"><div class="shrow"><span class="shday">Lunes</span><span class="shpair"><input type="time" id="cal_mon_1a"><span class="shsep">a</span><input type="time" id="cal_mon_1b"></span><span class="shpair"><input type="time" id="cal_mon_2a"><span class="shsep">a</span><input type="time" id="cal_mon_2b"></span></div><div class="shrow"><span class="shday">Martes</span><span class="shpair"><input type="time" id="cal_tue_1a"><span class="shsep">a</span><input type="time" id="cal_tue_1b"></span><span class="shpair"><input type="time" id="cal_tue_2a"><span class="shsep">a</span><input type="time" id="cal_tue_2b"></span></div><div class="shrow"><span class="shday">Miércoles</span><span class="shpair"><input type="time" id="cal_wed_1a"><span class="shsep">a</span><input type="time" id="cal_wed_1b"></span><span class="shpair"><input type="time" id="cal_wed_2a"><span class="shsep">a</span><input type="time" id="cal_wed_2b"></span></div><div class="shrow"><span class="shday">Jueves</span><span class="shpair"><input type="time" id="cal_thu_1a"><span class="shsep">a</span><input type="time" id="cal_thu_1b"></span><span class="shpair"><input type="time" id="cal_thu_2a"><span class="shsep">a</span><input type="time" id="cal_thu_2b"></span></div><div class="shrow"><span class="shday">Viernes</span><span class="shpair"><input type="time" id="cal_fri_1a"><span class="shsep">a</span><input type="time" id="cal_fri_1b"></span><span class="shpair"><input type="time" id="cal_fri_2a"><span class="shsep">a</span><input type="time" id="cal_fri_2b"></span></div><div class="shrow"><span class="shday">Sábado</span><span class="shpair"><input type="time" id="cal_sat_1a"><span class="shsep">a</span><input type="time" id="cal_sat_1b"></span><span class="shpair"><input type="time" id="cal_sat_2a"><span class="shsep">a</span><input type="time" id="cal_sat_2b"></span></div><div class="shrow"><span class="shday">Domingo</span><span class="shpair"><input type="time" id="cal_sun_1a"><span class="shsep">a</span><input type="time" id="cal_sun_1b"></span><span class="shpair"><input type="time" id="cal_sun_2a"><span class="shsep">a</span><input type="time" id="cal_sun_2b"></span></div></div>
<div class="actions actions0"><button class="btn alt btnsm" id="calCopy" type="button">Copiar el lunes a L-V</button><span class="muted" id="calHoursOut"></span></div></div>
...
<div class="card mt12"><b>Color de la burbuja del equipo</b>
<p class="muted mt6">Cuando una persona del equipo responde en el chat, su burbuja se distingue de la del asistente con este color. <b>Vacío = el color de marca de arriba</b>, así que normalmente no hay que tocarlo. Cámbialo solo si el color de marca choca con el verde del visitante.</p>
<div class="note mt6"><input id="tAgentColor" placeholder="#5b3fa8" class="w150"></div>
<small class="muted">Es el acento: el fondo se calcula a partir de él para que el texto siempre se lea, en tema claro y oscuro.</small>
<small class="muted field-err" data-f="agent_color"></small></div>
